...
namespace CHARACTERS
{
    public class CharacterManager : MonoBehaviour
    {
        ...
        private CharacterConfigSO config => DialogSystem.instance.config.characterConfigurationAsset;
        ...
        public Character GetCharacter(string characterName, bool createIdDoesNotExist = false)
        {
            if (characters.ContainsKey(characterName.ToLower()))
                return characters[characterName.ToLower()];
            else if (createIdDoesNotExist)
        ...
        public void SortCharacters(string[] characterNames)
        {
            ...
            for(int i = 0; i < sortedCharacters.Count; i++)
            {
                ...
                character.SetPriority(startingPriority + i + 1, autoSorteCharactersOnUI: false);
