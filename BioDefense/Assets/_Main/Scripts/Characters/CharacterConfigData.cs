...
namespace CHARACTERS
{
    ...
    public class CharacterConfigData
    {
        ...
        private static Color defaultColor => DialogSystem.instance.config.defaultTextColor;
        private static TMP_FontAsset defaultFont => DialogSystem.instance.config.defaultFont;
